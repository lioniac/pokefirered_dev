...
static const u16 sTimeOfDayTints[][3] = {
    ...
    [2] =   {TINT_NIGHT},
    [3] =   {TINT_NIGHT},
    [4] =   {Q_8_8(0.4), Q_8_8(0.45), Q_8_8(1.0)},
    [5] =   {Q_8_8(0.55), Q_8_8(0.6), Q_8_8(1.0)},
    [6] =   {TINT_MORNING},
    [7] =   {TINT_MORNING},
    [8] =   {TINT_MORNING},
    [9] =   {TINT_MORNING},
    [10] =  {Q_8_8(0.9), Q_8_8(0.85), Q_8_8(1.0)},
    [11] =  {Q_8_8(1.0), Q_8_8(0.9), Q_8_8(1.0)},
    [12] =  {TINT_DAY},
    [13] =  {TINT_DAY},
    [14] =  {TINT_DAY},
    [15] =  {TINT_DAY},
    [16] =  {TINT_DAY},
    [17] =  {TINT_DAY},
    [18] =  {Q_8_8(0.9), Q_8_8(0.88), Q_8_8(0.9)},
    [19] =  {Q_8_8(0.7), Q_8_8(0.77), Q_8_8(0.67)},
    [20] =  {Q_8_8(0.55), Q_8_8(0.55), Q_8_8(0.77)},
    [21] =  {Q_8_8(0.5), Q_8_8(0.44), Q_8_8(0.82)},
    [22] =  {TINT_NIGHT},
    [23] =  {TINT_NIGHT},
};
...
static void LoadPaletteOverrides(void)
{
    ...
    for (i = 0; i < NELEMS(gPaletteOverrides); i++)
    {
